...
public class jifrmEmpleados extends javax.swing.JInternalFrame {
     ...
     String titulos[] = {"idEmpledo", "Apellidos", "Nombres", "Cedula", "Correo", "Telefono", "Direccion"};
    ...
    public jifrmEmpleados() {
        ...
        rbtnIdEmpleado.setSelected(true);
         columnasAutoAjustable(tblEmpleado);
        buscarEmpleado();
    ...
    private void initComponents() {
        ...
        EMPLEADOSS = new javax.swing.ButtonGroup();
        ...
        pFormularioDatos.setBackground(new java.awt.Color(102, 102, 255));

        lblIdEmpleado.setBorder(javax.swing.BorderFactory.createTitledBorder("Id Empleados"));
        ...
        pFormularioDatosLayout.setHorizontalGroup(
            ...
            .addGroup(pFormularioDatosLayout.createSequentialGroup()
                ...
                .addGroup(pFormularioDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(lblIdEmpleado, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
        ...
        pFormularioDatosLayout.setVerticalGroup(
            ...
            .addGroup(pFormularioDatosLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblIdEmpleado, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5, 5, 5)
        ...
        tbDatos.addTab("Empleados", pFormularioDatos);

        tblEmpleado.setBackground(new java.awt.Color(102, 204, 255));
        ...
        tblEmpleado.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);

        jPanel1.setBackground(new java.awt.Color(255, 153, 153));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Buscar por:"));

        EMPLEADOSS.add(rbtnApellido);
        rbtnApellido.setText("Apellido");

        EMPLEADOSS.add(rbtnNombre);
        rbtnNombre.setText("Nombre");

        EMPLEADOSS.add(rbtnCedula);
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(validar()){
            Empleados emp = new Empleados(txtApellido.getText(),txtNombre.getText(),txtCedula.getText(), txtCorreo.getText(),txtTelefono.getText(), txtDireccion.getText(),txtCargo.getText());
            emp.guardar();
        }else{
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
      emp = new Empleados(Integer.parseInt(lblIdEmpleado.getText()),txtApellido.getText(),txtNombre.getText(),txtCedula.getText(), txtCorreo.getText(),txtTelefono.getText(), txtDireccion.getText(),txtCargo.getText());
       emp.actualizar();
       buscarEmpleado();
       habilitarBotonesInicio();
...
public void cargarDatosFormulario(String msj) {
        ...
        if (msj.equals("limpiar")) {
            ...
            Integer fila = tblEmpleado.getSelectedRow();
            if (fila == -1) {
                JOptionPane.showMessageDialog(null, "Se debe seleccionar un registro");
            } else {
                dtm = (DefaultTableModel) tblEmpleado.getModel();
                emp = new Empleados(Integer.parseInt(dtm.getValueAt(fila, 0).toString()),
        ...
        lblIdEmpleado.setText(emp.getIdEmpleado().toString());
        ...
        strCodigo = (emp.getIdEmpleado().toString());

    }

     
public void columnasAutoAjustable(JTable tabla) {
        tabla.setAutoResizeMode(tblEmpleado.AUTO_RESIZE_OFF);
    ...
    private javax.swing.ButtonGroup EMPLEADOSS;
