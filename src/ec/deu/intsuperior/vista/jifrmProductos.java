...
public class jifrmProductos extends javax.swing.JInternalFrame {
     ...
     String titulos[] = {"idProducto", "Descripcion", "Codigo", "Unidad de Medida", "Informacion Nutricional", "ObservacionN"};
    ...
    public jifrmProductos() {
        ...
        columnasAutoAjustable(tblProductos); 
        buscarProducto();
    ...
    private void initComponents() {
        ...
        txtInfoNutricionn = new javax.swing.JTextField();
        ...
        rbtnUnidadMedida = new javax.swing.JRadioButton();
        ...
        pFormularioDatos.setBackground(new java.awt.Color(153, 153, 255));

        lblIdProducto.setBorder(javax.swing.BorderFactory.createTitledBorder("Id Producto"));
        ...
        txtUnidadMedida.setBorder(javax.swing.BorderFactory.createTitledBorder("Unidad de Medida"));

        txtInfoNutricionn.setBorder(javax.swing.BorderFactory.createTitledBorder("Informacion Nutricional"));
        ...
        pFormularioDatosLayout.setHorizontalGroup(
            ...
            .addGroup(pFormularioDatosLayout.createSequentialGroup()
                ...
                .addGroup(pFormularioDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lblIdProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtDescripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 265, Short.MAX_VALUE)
                    .addComponent(txtUnidadMedida)
                    .addComponent(txtCodigo)
                    .addComponent(txtInfoNutricionn)
        ...
        pFormularioDatosLayout.setVerticalGroup(
            ...
            .addGroup(pFormularioDatosLayout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(lblIdProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(18, 18, 18)
                .addComponent(txtInfoNutricionn, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(txtObservacion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(62, Short.MAX_VALUE))
        );

        tbDatos.addTab("Productos", pFormularioDatos);

        jPanel1.setBackground(new java.awt.Color(102, 102, 102));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Buscar por:"));

        PRODUCTOS.add(rbtnIdProducto);
        rbtnIdProducto.setText("Id Producto");

        PRODUCTOS.add(rbtnDescripcion);
        rbtnDescripcion.setText("Descripcion");

        PRODUCTOS.add(rbtnCodigo);
        rbtnCodigo.setText("Codigo");

        PRODUCTOS.add(rbtnUnidadMedida);
        rbtnUnidadMedida.setText("Unidad de Medida");

        txtBuscar.setBorder(javax.swing.BorderFactory.createTitledBorder("Ingrese Texto  de Busqueda"));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tbDatos, javax.swing.GroupLayout.PREFERRED_SIZE, 429, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
          if(validar()){
            Productos pro = new Productos(txtDescripcion.getText(),txtCodigo.getText(),txtUnidadMedida.getText(), txtInfoNutricionn.getText(),txtObservacion.getText());
            pro.guardar();
        }else{
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        prod = new Productos(Integer.parseInt(lblIdProducto.getText()),txtDescripcion.getText(),txtCodigo.getText(),txtUnidadMedida.getText(), txtInfoNutricionn.getText(),txtObservacion.getText());
       prod.actualizar();
       buscarProducto();
       habilitarBotonesInicio();
...
public void buscarProducto() {
        String titulos[] = {"IdProducto", "Descripcion", "Codigo", "Unidad de Medida", "Informacion Nutricional", "Observacion"};
        ...
        if (rbtnIdProducto.isSelected()) {
            ...
            criterio = "codigo";
        } else if (rbtnUnidadMedida.isSelected()) {
...
public void cargarDatosFormulario(String msj) {
        ...
        if (msj.equals("limpiar")) {
            ...
            if (fila == -1) {
                ...
                prod = new Productos(Integer.parseInt(dtm.getValueAt(fila, 0).toString()),
...
public void habilitarBotonesProceso(){
        ...
        txtInfoNutricionn.setEnabled(true);
     ...
     public void habilitarBotonesInicio(){
        ...
        txtInfoNutricionn.setEnabled(false);
...
public void columnasAutoAjustable(JTable tabla) {
        tabla.setAutoResizeMode(tblProductos.AUTO_RESIZE_OFF);
    ...
    private javax.swing.JRadioButton rbtnUnidadMedida;
    private javax.swing.JTabbedPane tbDatos;
    private javax.swing.JTable tblProductos;
    private javax.swing.JTextField txtBuscar;
    private javax.swing.JTextField txtCodigo;
    private javax.swing.JTextField txtDescripcion;
    private javax.swing.JTextField txtInfoNutricionn;
